...
- [ ] [ready] `bug` `atelier-pr-size-check` aborts under `set -u` (`repo_flag[@]` unbound) → counts 0/0 in PR mode `#28` `~TODO` — [detail](roadmap/TASK_028_pr-size-check-unbound-variable.md)
