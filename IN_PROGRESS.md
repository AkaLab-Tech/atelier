...
**Branch (current sub-PR):** `setup/m1.3-phase-c-2` — Phase C.2: drive `claude plugin` CLI to add marketplace + install both plugins, with idempotency + missing/unauthed fallback.
